document.addEventListener("DOMContentLoaded", function () {
    ...
    const emiratesIdAttachment =
        document.getElementById("emiratesIdAttachment");

    const passportAttachment =
        document.getElementById("passportAttachment");

    const qualificationAttachment =
        document.getElementById("qualificationAttachment");
